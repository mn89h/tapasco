namespace eval BuildArchIfc {
  ...
  proc create_proj {} {
    ...
    set filepaths "$arke_dir/common/src/Arke_pkg.vhd $arke_dir/common/src/NIC_pkg.vhd $arke_dir/common/src/STD_FIFO.vhd $arke_dir/common/src/AXI4_Lite_Slave.vhd $arke_dir/noc_arke_arch_ifc/src/Arch_Ifc.vhd"
  ...
  proc set_user_parameters {{address_width 12}} {
    ...
    set_property value {""} [ipx::get_user_parameters AXI_ranges -of_objects [ipx::current_core]]
    set_property value {""} [ipx::get_hdl_parameters AXI_ranges -of_objects [ipx::current_core]]
    set_property value_bit_string_length 1000 [ipx::get_user_parameters AXI_ranges -of_objects [ipx::current_core]]
    set_property value_bit_string_length 1000 [ipx::get_hdl_parameters AXI_ranges -of_objects [ipx::current_core]]
    ...
    set_property value_bit_string_length 1000 [ipx::get_user_parameters NoC_targets -of_objects [ipx::current_core]]
    set_property value_bit_string_length 1000 [ipx::get_hdl_parameters NoC_targets -of_objects [ipx::current_core]]
  ...
  proc build_gui {} {
    ...
    ipgui::move_param -component [ipx::current_core] -order 7 [ipgui::get_guiparamspec -name "A4L_addr_width" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]
    ipgui::move_param -component [ipx::current_core] -order 8 [ipgui::get_guiparamspec -name "A4L_data_width" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]
    ipgui::move_param -component [ipx::current_core] -order 9 [ipgui::get_guiparamspec -name "A4L_strb_width" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]
    ipgui::move_param -component [ipx::current_core] -order 11 [ipgui::get_guiparamspec -name "AXI_base_addr" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]
    ipgui::move_param -component [ipx::current_core] -order 12 [ipgui::get_guiparamspec -name "AXI_ranges" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]
    ipgui::move_param -component [ipx::current_core] -order 13 [ipgui::get_guiparamspec -name "AXI_ranges_cnt" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]
    ipgui::move_param -component [ipx::current_core] -order 14 [ipgui::get_guiparamspec -name "NoC_targets" -component [ipx::current_core]] -parent [ipgui::get_pagespec -name "Page 0" -component [ipx::current_core]]
  }
  ...
  proc purge_proj {} {
    ...
    close_project -delete
    file delete $arke_dir/project_arch_ifc
  }
