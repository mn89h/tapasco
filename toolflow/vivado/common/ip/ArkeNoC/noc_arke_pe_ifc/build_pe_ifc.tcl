namespace eval BuildPEIfc {
  ...
  proc create_proj {} {
    variable arke_dir
    create_project project_pe_ifc $arke_dir/project_pe_ifc -part xc7z020clg400-1 -force
    set filepaths "$arke_dir/common/src/STD_FIFO.vhd $arke_dir/common/src/AXI4_Full_Slave.vhd $arke_dir/common/src/AXI4_Lite_Master.vhd $arke_dir/common/src/NIC_pkg.vhd $arke_dir/common/src/Arke_pkg.vhd $arke_dir/noc_arke_pe_ifc/src/PE_Ifc.vhd"
  ...
  proc open_proj {} {
    ...
    if {[catch {current_project} result ]} {
      puts "DEBUG:$result"
      open_project $arke_dir/project_pe_ifc/project_pe_ifc.xpr
    } else {
  ...
  proc package_project {} {
    ...
    ipx::edit_ip_in_project -upgrade true -name tmp_edit_project -directory $arke_dir/noc_arke_pe_ifc $arke_dir/noc_arke_pe_ifc/component.xml
  }
