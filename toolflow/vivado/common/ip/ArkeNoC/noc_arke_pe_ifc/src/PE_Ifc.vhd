...
architecture Behavioral of PE_Ifc is
    ...
    begin
        ...
        process(clk)
            ...
            --todo
            variable A4F_rdrqA_get_data_tmp : std_logic_vector(A4F_rdrqa_width - 1 downto 0);
            variable A4F_wrrqA_get_data_tmp : std_logic_vector(A4F_wrrqa_width - 1 downto 0);
            variable A4F_wrrqD_get_data_tmp : std_logic_vector(A4F_wrrqd_width - 1 downto 0);
