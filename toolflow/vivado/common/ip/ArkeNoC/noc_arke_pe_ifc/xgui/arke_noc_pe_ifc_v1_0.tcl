...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "address_arch" -parent ${Page_0}
  ipgui::add_param $IPINST -name "address_mem" -parent ${Page_0}
...
proc update_PARAM_VALUE.address_arch { PARAM_VALUE.address_arch } {
	# Procedure called to update address_arch when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.address_arch { PARAM_VALUE.address_arch } {
	# Procedure called to validate address_arch
	return true
}

proc update_PARAM_VALUE.address_mem { PARAM_VALUE.address_mem } {
	# Procedure called to update address_mem when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.address_mem { PARAM_VALUE.address_mem } {
	# Procedure called to validate address_mem
	return true
}
...
proc update_MODELPARAM_VALUE.address_mem { MODELPARAM_VALUE.address_mem PARAM_VALUE.address_mem } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.address_mem}] ${MODELPARAM_VALUE.address_mem}
}

proc update_MODELPARAM_VALUE.address_arch { MODELPARAM_VALUE.address_arch PARAM_VALUE.address_arch } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.address_arch}] ${MODELPARAM_VALUE.address_arch}
}
